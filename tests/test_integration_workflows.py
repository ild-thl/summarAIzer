...
async def test_full_workflow_execution_talk_workflow(
    ...
    step1 = create_mock_step(
        identifier="summary",
        dependencies=[],
        generate_result={"content": "Summary content", "content_type": "text", "meta_info": {}},
    )
    step2 = create_mock_step(
        identifier="key_takeaways",
        dependencies=["summary"],
        generate_result={"content": "Key takeaways", "content_type": "text", "meta_info": {}},
    )
...
@pytest.mark.asyncio
async def test_task_receives_correct_step_ids(mock_db_session, mock_session_model, clean_registries):
